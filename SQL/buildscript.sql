...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (1, N'WELCOME ABOARD! The year is 2525 A.D., an age when mankind is moving out among the stars.
...
GO TO PAGE 2.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (2, N'Captain Polaris has summoned you — and when Polaris calls, you run. You''re a bit out of breath when you reach the busy Teleportation Room of the artifi- cial moon called the Nebula. Judging by your clammy palms, you''re a little nervous, too. After all, you''re still a new recruit.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (4, N'As the Challenger orbits the Amusement Planet, you prepare to warp down. "We''ll arrive in a big ware- house," 2-Tor says. "Mice and quiet."
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (5, N'The beasts are too close. You hold your nose, close your eyes, and jump.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (6, N'You and 2-Tor decide to be tourists. You leave the Challenger in the orbit sector for tourist vehicles, and warp down to the planet.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (7, N'[Image of Spaceships flying over planet]')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (8, N'You have 2-Tor send a request to the Nebula, and very shortly your xenologist beams in.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (9, N'You don''t stand a chance against the Mungoid. Besides, this may be a good way to find out what''s going on. "We give up," you say.
...
turn to page 12.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (10, N'You wrench free from the Mungoid and start run- ning. You flash past ride after ride, face after face. Hands grab at you as you run.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (11, N'"Let''s do this one alone, 2-Tor," you say.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (12, N'Maybe 2-Tor is right. You shouldn''t come in and start busting things up right away.
...
Go to 13.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (13, N'You mean, this happens all the time?"
...
turn to page 18. ')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (14, N'You can''t leave 2-Tor stranded. You grit your teeth, take a deep breath, and make your way back. The place is like a giant rat-maze, and you sense danger at every turn.
...
Go to page 73.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (15, N'The three of you walk around warily, as your xenographerjots down notes. Suddenly she is jostled roughly by a passing alien of unknown origin.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (16, N'[Image of person on what appears to be a moving ledge]')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (17, N'You look around, taking stock. You have ended up on a moss-covered ledge, overhanging a steep ravine. Below you are many more green ledges, and at your back rises a steep cliff. You stand where you are, tryingto calm down. At least you''re safe where you are.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (18, N'Abandoning the mission isn''t a glorious choice, but you''ve just about had it. You''ll be glad to get off this miserable planet alive.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (19, N'You and 2-Tor give chase to the Ardanian, knowing you''ll probably be in for trouble when you find it.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (20, N'"I think we know enough right now," you whisper, out of the Mungoid''s hearing. "Nothing good is hap- pening here. Try shutting it down, 2-Tor."
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (21, N'You know you can trust 2-Tor to come up with an answer. So you stand there smiling dumbly at the intruder, waiting for the robot to give you information.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (22, N'"Just who are you?" you demand of the "first mate," as 2-Tor flashes its blue lights.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (23, N'What action can you think of? You end up roaming the corridors of the funhouse, banging on walls and kicking in doors.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (24, N'As coolly as you can, you raise your arm. You level your pulser at the Ardanian''s head, trying to convince yourself that you''ll kill it if you have to. That way, it will be convinced, too.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (25, N'You''ll see that the Ardanian is punished later by a court of law. Perhaps you can also force it to make the crewmembers reappear. But meantime the first order of business is to set it free.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (26, N'The funhouse looks like a good place for evil- doing. It''s big and has no windows.
...
Go to page 63')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (27, N'You race for the bridge, the beasts gaining on you. yourlungs are bursting. The whistling sound is ear- splitting. Almost there ... a few more meters — Dive forit!
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (28, N'You keep walking along, horrified by what you see. After a while 2-Tor speaks up.
...
turn to page 81.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (29, N'You stand bravely in the dim sunlight, blasting your micro-pulserto stun the rock creatures. It''s hard to tell whether you''re doing them any real damage, though. How do you tell a conscious rock from an
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (30, N'"Back to the funhouse!" you cry.
...
Go to page 67.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (31, N'You take the direct approach. "How do I know she''s real?" you ask the Brakhen.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (32, N'It takes every bit of your strength to hang on to the flipper as it whips back and forth. Fighting dizziness, you swallow hard and concentrate on the bright arched doorway. If you can get there, at least you''ll be on solid ground.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (33, N'[Image of person hanging off of wall/ledge and trying to climb up]')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (34, N'Finally the wall comes down — at exactly the same moment your pulser runs out of energy.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (35, N'The sideshow is just as unpleasant as it promised to be. You walk past rows of the most gruesome, misshapen life forms you could ever imagine. Some are mutants, or unfortunate hybrids of two alien races. Some look almost inside-out One of them has so little structure, it has to live in a tube.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (36, N'You begin to hunt for Dr. Caxton, threading in and out among the sleepers. She doesn''t seem to be there.
...
Go to page 80.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (37, N'It''s too dangerous to keep blasting. You must let 2-Tor replenish his power.
...
Go to page 77')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (38, N'There''s a woman who''s a likely prospect. She''s dancing, but not with anybody. Her eyes have that funny look the others have.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (39, N'You leave the sideshow through a rip in the tent Next is a low, long building with extremely thick walls. "Let''s check it out," you say.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (40, N'You set your pulser for BLAST. Then you aim its needle beam right for the thing''s heart — if it has a heart, that is. You know you have only one chance.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (41, N'The next thing you''re aware of is a deep and mighty rumble from the guts of the Amusement Planet. It''s taking off!
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (42, N'Using a trick from the Nebula rulebook, you test Dr. Caxton by giving the secret recognition signal. It''s an almost-invisible twitch. But she should pick it up.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (43, N'You know 2-Tor is right, but your will is being sapped from you. The feeling of giddiness and insane happiness gets stronger and stronger. You fight to hold on to your reason. If Tor weren''t there, you''d lose it.
...
Go to page 41.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (44, N'Oh, no! It''s Nyx — the worst planet in the universe.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (45, N'You plunge into the thick of the crowd, hoping to find a clue to what''s going on. The people look as though they''re having a good time. Yet they have strange tics. And their eyes look dazed.
...
turn to page 38.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (46, N'The good news is, you find Dr. Caxton. You''re in the same work gang as she is.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (47, N'[Image of a furry creature in a uniform]')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (48, N'You contact the Nebula for help, but it doesn''t come any too soon. At last your reinforcements warp in.
...
Go to page 78.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (49, N'With as blood-curdling a yell as you can manage, you leap for the leader. It''s hard to figure out where to grab him, and 2-Tor can''t help you much.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (50, N'You still haven''t accomplished your mission. You haven''t found out what the Kron are up to in The Cosmic Funhouse.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (51, N'You may temporarily blind them," says 2-Tor, clicking and buzzing furiously. "All you need is an intense heat flash from your micro-pulser."
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (52, N'As you run toward the hole, you realize how this all came about.
...
Go to page 60.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (53, N'You untie Dr. Caxton and begin running. Maybe you''ll find somebody else on this planet, someone who''ll help you. Or maybe 2-Tor will think of some- thing.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (54, N'You follow the glow. As you get closer, it grows brighter — and you have trouble moving.
...
Go to page 55.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (55, N'You manage to get off one shot before you''re rooted to the spot. You watch as the wounded alien begins to grow dim. As its glow gets fainter, you can hear the whole Cosmic Funhouse shutting down.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (56, N'You feel safe returning to the Nebula, even with a Kron fighter on your tail. "2-Tor," you say, "maybe we should transmit ahead and let them know they''re getting company."
...
Go to page 72.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (57, N'"I''ll fight," you say.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (58, N'Moving quickly, you get the drop on the Brakhen, grabbing it around the throat. Vinelike growths try to shake off your arms.
...
Go to page 59.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (59, N'"Why don''t you let them go?" "We have let them go," it answers. "Strictly speaking, that is. These people are clones." "Clones!"
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (60, N'The computer goes haywire.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (61, N'The faceless monster keeps heading toward you. It seems to glide along, not touching the ground. You stand firm, praying that your gamble that it is an illusion is the right one.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (62, N'[Image of person that appears to be floating in darkness, with a door and a mirror above them.]')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (63, N'"2-Tor," you say, "maybe we should — " But you stop when you realize that no sound is coming out. You can''t hear your own voice. Even your telepathic link with 2-Tor is cut.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (64, N'Suddenly you have another problem. Zombielike, the people in the room are moving in on you. They don''t look as if they want to shake hands, either.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (65, N'A blazing firefight ensues. Pulser-blasts are flying everywhere, bouncing off walls and ripping holes in the command module.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (66, N'Your pulser set for BLAST, you turn to face the monster. At that instant you see something interest- ing out of the corner of your eye. It''s a machine, and it looks something like the machine you left behind in the funhouse. Not exactly like it, especially with those snakes pouring out of it — but something like it. On an impulse, you turn your weapon toward it and blast.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (67, N'"We needs his parts," says the mutant leader. He''s almost begging you. "Don''t you see? He has the last part we need, a capacitor for our teleported"
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (68, N'2-Tor beams you up to the Challenger in short order. But your problems aren''t over yet. You''ve just strapped yourself into your seat in the command module when a deep rumbling begins to vibrate your insides. You look through the visisteel window before you. There, at point-blank range, is a Kron starfighter. Before you have time to catch your breath, much less throw up your shields, the Challenger is rocked by a direct hit.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (69, N'Act tough, you say to yourself. Don''t back down. You feel better after this little pep talk, so you swagger over to the group in the sand-hover.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (70, N'Warily you approach the huge flippers. One false move and you''ll be squashed. But they may be your ticket out of there.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (71, N'You lurch to the machine. Frantically, you turn every dial and every lever you can get your hands on.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (72, N'When you reach headquarters, the Nebula is ready. A dozen fighters have been scrambled, and the Kron ship''s frequencies are jammed so it''s cut off from the funnouse.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (73, N'"2-Tor!" You must find him soon. The Mungoids won''t stay unconscious for long.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (74, N'Your jump from the flipper lands you safely in the dark corridor. You run through it, grateful to be alive.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (75, N'"Just a minute," you say, in a desperate attempt to gain more time. "I''ll fight, but you have to let her go." You point to the xenologist. The warriors have a conference, which means a lot of shouting and shoving.
...
Go to page 51.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (76, N'The surface of the mirror ripples like a lake full of fish. It seems to invite you to step through it. You do.
...
Go to page 99.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (77, N'The force-field dissolves. You see a roomful of Brakhen and Dr. Caxton. She doesn''t see you yet. She seems to be fine, though. She''s observing away, looking at a funhouse mess.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (78, N'"Great," you say to yourself. "Just my luck."
...
turn to page 84.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (79, N'[Image of person held captive by lizard creature]')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (80, N'Suddenly the glow is gone! You can see again! You look around, still shaking from the experience you''ve just had. As you get your bearings, you realize you''re outside the funhouse.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (81, N'You don''t have to wait long. The Ardanian pops back into view, beckoning urgently to you and 2-Tor. You follow as it leads you to a quiet, secluded corner.
...
Go to page 82.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (82, N'"What do you mean, got us to come here?" you demand.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (83, N'You and 2-Tor brace yourselves for the fight of your lives. You don''t expect much help from the furry fellows you''ve been sent But you''re wrong. They were just waiting for the odds to get interesting.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (84, N'"Warp, 2-Tor!" you yell. "Right now!" "Shall we try to follow Dr. Caxton?" he asks. "Why not?" you say. "Just get us out of here!" Tor whisks you and the furry guys into warp-space. You''re off to the unfamiliar coordinates he''s read from the transporter beam. Who knows what awaits
...
Go to page 46.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (85, N'"Well, I''m satisfied, Tor," you say. "Case closed. Let''s warp out of here."
...
Go to page 41.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (86, N'Tethered to the Challenger, you float along its hull until you locate the damage. It''s bad. It will take more than just reconnecting the terminals. You''ll be out there doing repairs for quite a while.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (87, N'The wide beam seems to have no effect on the plants at all. Well, maybe just one: It gets them very angry.
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (88, N'After a while, you begin to feel peculiar.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (89, N'[Image of alien creature]')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (90, N'As you make your final approach to the Amuse- ment Planet, you do a double take. "2-Tor, do you see what I see?" you ask in amazement
...
You have completed your mission. Report to the Nebula on page 1 15 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (91, N'Your needle beam is quite effective. As each at- tacker gets too close, you reduce it to a frizzle. But you can''t hold out long this way. There are thousands of them, and they''re getting crankier by the moment
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (92, N'You give it all you''ve got with your micro-pulser. But this is no ordinary wall: It''s a force-field. You may be able to dissolve it if you fire full strength.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (93, N'Being a slave to a band of killers doesn''t sound like fun, but it beats dying. Maybe you can buy some time.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (94, N'"We''ll just get blown up if we hang around here," you say. "Let''s get our tails out of here."
...
turn to page 114.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (95, N'You run for the solitary crag, wondering what you''ll
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (96, N'A short way down the hall you spot a door that
...
turn to page 36.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (97, N'Well, you''re on the run again. You''d rather not go out the door you just came in. Maybe you''ll have better luck with the one across the room. Each of your steps feels a couple of kilometers long. And after what seems like a week, you reach the door.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (98, N'If you can shut the telepathy machine off, you''ll feel better. So will all these other people.
...
Go to page 64.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (99, N'"Who are you?" you whisper in horror.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (100, N'[Image of person falling into black sphere]')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (101, N'You hesitate in front of the cage, horrified at what you''re seeing. The prisoners claw at the bars of the cage. "Save yourself!" cries one. "The hole! Go for the hole!" yells another.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (102, N'"Let''s get out of here," you say. 2-Tor follows you, but falls behind.
...
turn to page 98.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (103, N'You work your way to the middle of the room, feeling better the closer you get You''ve never felt this
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (104, N'"We''ll certainly investigate this matter further. But you''ll have to stop causing trouble."
...
ZAP!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (105, N'"We''d better go after her," you say, sounding a lot braver than you feel. You clench your fists as 2-Tor warps you both to the unknown location.
...
Go to page 107.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (106, N'Cautiously you open the door, stepping into the bright light of another world. For a moment you''re blinded.
...
; .
 Go to page 113.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (107, N'The warriors dismount from the hover, hustling Dr. Caxton before them. They seem to be as violent with each other as with the outsider, pushing, elbowing, and cursing. 2-Tor silently translates their speech for
you.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (108, N'Below you, you see a strange glow coming from the bottom of the ravine. It is a bright light that changes color all the time.
...
Go to page 101.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (109, N'You take a flying leap at the drainer and start smashing it with your disappearing fists. You''ve sur- prised it. It didn''t expect such a foolhardy, primitive attack.
...
You have completed your mission. Report to the Nebula on page 1 15 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (110, N'You take a deep breath and set your pulser for STCJM It''s you or them, and this won''t do any perma- nent damage.
...
Go to page 111.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (111, N'Suddenly the door flies open. Three Kron come storming into the room, leaving trails of slime behind them. Strange that they don''t seem to be having any
...
Go to page 44.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (112, N'"Welcome to the G.P.B.," says the other.
...
You have completed your mission. Report to the Nebula on page 115 to find out how you rate as a Space Ace.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (113, N'Your ears pick up a faint sound, coming from your left. A low whistling noise.
...
turn to page 5.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (114, N'It''s a long way to Antares, and it takes several hours, even at warp speed. The fighter does not stay with you.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (115, N'WE MADE IT, BOSS! REMEMBER THE PAGE NUMBER YOU CAME FROM, AND CHECK THE SCORES ON THE NEXT PAGE!')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (116, N'IF YOU WARPED IN FROM PAGE: 60, you get 7,821,806 points. 112, you get 9,712,319 points.
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (117, N'PAGE:
27, you get 8,943 points. 41, you get 6,842 points. 59, you get 4,407 points. 66, you get 5,845 points.
YOU''RE ASSIGNED TO ASTEROID PATROL UNTIL FURTHER NOTICE.
74, you get 2,877 points.
IF YOU WARPED IN FROM PAGE:
46, you get 117 points.
71, you get 234 points.
72, you get 492 points. 103, you get 192 points.
GO BACK TO THE SPACE ACADEMY!')
GO
