USE master;
GO
drop database if exists ChooseYourOwnAdventure;
CREATE database ChooseYourOwnAdventure;
...
GO TO PAGE 2.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (2, N'Captain Polaris has summoned you — and when Polaris calls, you run. 
...
Go to page 3.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (3, N'"That's all you need," says Polaris, "except for one thing. We've had some 
...
If you decide to slip unseen into the Amusement Planet, enter A. turn to page 4.  

If you want to go as a tourist, enter B. turn to page 6.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (4, N'As the Challenger orbits the Amusement Planet, you prepare to warp down. 
...
"Mungoids!" says 2-Tor. "Galactic thugs!"  If you let the Mungoid force you into The Cosmic Funhouse, turn to page 9.  If you want to try to break and run, turn to page 10.')
GO
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (6, N'You and 2-Tor decide to be tourists. You leave the Challenger in the orbit 
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (8, N'You have 2-Tor send a request to the Nebula, and very 
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (9, N'You don't stand a chance against the Mungoid. Besides, this may be a 
...
turn to page 12.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (10, N'You wrench free from the Mungoid and start running. 
...
If you go back for 2-Tor, turn to page 14.  If you stay where you''re safe, hoping he finds you, turn to page 17.')
GO
...
Ifyou want to go to the funhouse, turn to page 26. Ifyou choose the sideshow, turn to page 35. ')
GO
...
If you decide to have 2-Tor warp you both back to the funhouse, turn to page 30.
I fyou want to abandon the mission, pick up the Challenger and return to the Nebula,
turn to page 18. ')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (14, N'You can't leave 2-Tor stranded. You grit your teeth, take a deep 
...
Go to page 73.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (15, N'The three of you walk around warily, as your xenographerjots down notes. 
...
"We could, or we could call the Nebula for help." If you want to go after her, 
turn to page 105. Ifyou want to signal for help, turn to page 48. ')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (16, N'[Image of person on what appears to be a moving ledge]')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (17, N'You look around, taking stock. You have ended up on a moss-covered ledge, 
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (18, N'Abandoning the mission isn't a glorious choice, but you've just 
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (20, N'"I think we know enough right now," you whisper, out of the Mungoid's 
...
Go to page 102.')
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (21, N'You know you can trust 2-Tor to come up with an answer. So you 
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (22, N'"Just who are you?" you demand of the "first mate," as 
...
GO
INSERT [dbo].[pages] ([page], [text]) VALUES (23, N'What action can you think of? You end up roaming the corridors of 
...
Ifyou want to blast through the wall, turn to page 92. Ifyou want to look for a door, turn to page 96.')
GO
